...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/skins/skin-gudezi.css": "build/less/skins/skin-gudezi.less",
      ...
      production: {
        ...
        files: {
          ...
          "dist/css/skins/skin-gudezi.min.css": "build/less/skins/skin-gudezi.less",
    ...
    includes: {
      ...
      build: {
        src: ['*.html'], // Source files
        dest: 'gudezi/', // Destination directory
        flatten: true,
        cwd: 'gudezi/build',
        options: {
          silent: true,
          includePath: 'gudezi/build/include'
        }
      }
    },
