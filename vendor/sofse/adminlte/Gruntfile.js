...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/skins/skin-blue.css": "build/less/skins/skin-sofse.less",
          "dist/css/skins/skin-sofse.css": "build/less/skins/skin-blue.less",
      ...
      production: {
        ...
        files: {
          ...
          "dist/css/skins/skin-sofse.min.css": "build/less/skins/skin-sofse.less",
    ...
    includes: {
      ...
      build: {
        src: ['*.html'], // Source files
        dest: 'sofse/', // Destination directory
        flatten: true,
        cwd: 'sofse/build',
        options: {
          silent: true,
          includePath: 'sofse/build/include'
        }
      }
    },
