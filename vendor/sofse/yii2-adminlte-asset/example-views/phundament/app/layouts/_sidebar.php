...
foreach (\sofse\helpers\Metadata::getModules() as $name => $module) {
    $role                        = $name;
    ...
    switch (true) {
        case (!empty($moduleConfigItem)):
            ...
            $moduleConfigItem['visible'] = \sofse\helpers\RouteAccess::can($moduleConfigItem['url']);
...
echo sofse\widgets\Menu::widget([
